...
public class SessionConstant {
    ...
    /** 用户sessionid */
    public static final String CURRENT_USER_INFO = "projname_login_customer";
    /** 当前店铺的id */
    ...
    /** 诸葛io的appKey */
    public static final String ZHUGEIO_APPKEY = "zhugeid_AppKey";
    /** 诸葛id记录用户的id */
    public static final String ZHUGEIO_USER_ID = "zhugeio_userId";
    /** 诸葛id记录用户的基本信息 */
    public static final String ZHUGEIO_USER_INFO = "zhugeio_userInfo";
}
