...
import com.example.common.bean.CommodityStyleVo;
import com.example.common.bean.ShopOutputDto;
...
public class MatrixToImageWriter {
	...
	private final static String rowText4="账号：test_retail";
	/**
...
//
	...
	private static void drawAllEle(BufferedImage image,CommodityStyleVo commVo,BufferedImage qrcodeImage,String commPic,String shopNo) throws IOException {
		...
		if(commVo.getIsPromotion() == 1){
			g.drawString("￥"+priceDf.format(commVo.getPromotionPrice()), 10,qrHeight+y+62);
		}else{
			//g.drawString("￥"+priceDf.format(commVo.getPrice()), 10,qrHeight+y+62);
		}
		g.setColor(Color.black);
		g.setFont(new Font("microsoft yahei",Font.TRUETYPE_FONT,14));
