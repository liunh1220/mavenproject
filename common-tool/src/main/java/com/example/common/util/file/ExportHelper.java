...
import com.example.common.bean.ExportParamsVo;
import com.example.common.bean.ResultMsg;
...
//		return resultMsg;
	...
	public static void doExportPDF(Map<Object, Object> params, String templatePath, String fileName, HttpServletResponse response) throws Exception {
		...
		//JdbcUtil utils = JdbcUtil.getInstance();
...
//			outputStream.flush();
	 ...
	 * @throws Exception
	 */
	public static void doExportCollectionPDF(List<ExportParamsVo> exportParamsVoList, 
