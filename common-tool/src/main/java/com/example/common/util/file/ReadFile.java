...
public class ReadFile {
     ...
     * @param fileName
     */
    private static void readFileByLines2(String fileName) {
        try {
            System.out.println("以行为单位读出文件内容:");
            File file = new File(fileName);
            Scanner scanner = new Scanner(file);
            int i = 0;
            while (scanner.hasNextLine()){
                System.out.println("line " + (++i) + ":" + scanner.nextLine());
            }
    ...
    public static void main(String[] args) {
        ...
        ReadFile.readFileByLines2(fileName);
