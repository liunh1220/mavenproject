...
/*
/**
 * combox控件 zhonglisen 1.0.0 使用方法，在页面引用combox.css和combox.js
...
combox.prototype.createDpList = function() {
    ...
    container.style.width = this.width-2 + "px";
