...
public class ImageValidate extends HttpServlet {
	...
	private static final long serialVersionUID = -2347448923198458167L;
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException,
	    ...
	    try {
	        ...
	        // 设定字体
	        g.setFont(new Font("Times New Roman", Font.CENTER_BASELINE, 14));
	        // 画边框
...
//	        session.setAttribute(Constant.LOGIN_VALIDATE_IMAGE, sRand);
	        ...
	        LoginInfo li = (LoginInfo)RemoteCacheUtil.getObject(CookieUtil.getCookieValue(request, Constant.TICKET));
	        if(li == null)
	        {
	        	li = new LoginInfo();
	        }
	        li.setValidationCode(sRand);
	        RemoteCacheUtil.setObject(CookieUtil.getCookieValue(request, Constant.TICKET), li);
