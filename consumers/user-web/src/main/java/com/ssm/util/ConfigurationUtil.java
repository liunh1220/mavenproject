...
import com.ssm.manager.IConfigurationManager;
...
public class ConfigurationUtil {
	...
	{
		IConfigurationManager configurationManager = (IConfigurationManager)ServiceLocator.getInstance().getBeanFactory().getBean("configurationManagerImpl");
	...
	{
		try {
			IConfigurationManager configurationManager = (IConfigurationManager) ServiceLocator
					.getInstance().getBeanFactory()
					.getBean("configurationManagerImpl");
