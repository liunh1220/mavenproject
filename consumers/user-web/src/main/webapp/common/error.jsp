...
obj.style.backgroundImage = "url('/image/loginimages/spacer.gif')";//替换透明PNG的图片
...
<script>
function closeTab() {
	var con = window.top.portal;
	if(con) {
 		con.contMgr.closeActiveTab();
 	} else {
 		history.go(-1);
 	}
}
...
<pre>
<p> 错误产生：<I>
	<%= exception != null ?  exception : (String)request.getAttribute("errorMsg")%>
	</I></p><br>
</pre>
</span></div>
<div style="clear:both;"></div>
</div>
<div class="mmi-bottom"><div style="text-align:right;width:506px;margin:0 auto;"><a href="#" class="easyui-linkbutton" onclick="window.history.back()" iconCls="icon-back">返回</a></div></div>
<center ></center>
</div>
</body>
</html>