...
import com.example.http.model.FileItem;
import com.example.http.util.StringUtil;
...
public class HttpRequester {
	 ...
	 * @throws IOException
	 */
	public static String doPost(String url, Map<String, String> params,int connectTimeout,int readTimeout,Map<String,String> head) throws IOException {
		return doPost(url, params, DEFAULT_CHARSET,connectTimeout,readTimeout,head);
	}
	/**
	 * 执行HTTP POST请求。
	 * 
	 ...
	 * @throws IOException
	 */
	public static String doPost(String url, Map<String, String> params, String charset,int connectTimeout,int readTimeout,Map<String,String> head)
			throws IOException {
		...
		return doPost(url, ctype, content, connectTimeout, readTimeout,head);
	}
	 ...
	 * @throws IOException
	 */
	public static String doPost(String url, String ctype, byte[] content,int connectTimeout,int readTimeout,Map<String,String> head) throws IOException {
		HttpURLConnection conn = null;
		OutputStream out = null;
		String rsp = null;
		try {
			try{
				conn = getConnection(new URL(url), METHOD_POST, ctype,head);	
			...
			try{
				...
				out.write(content);
				rsp = getResponseAsString(conn,DEFAULT_CHARSET);
			}catch(IOException e){
				throw e;
			}
	...
	public static String doPost(String url, Map<String, String> params,
			Map<String, FileItem> fileParams,int connectTimeout,int readTimeout,Map<String,String> head) throws IOException {
		if (fileParams == null || fileParams.isEmpty()) {
			return doPost(url, params, DEFAULT_CHARSET, connectTimeout, readTimeout,head);
		} else {
			return doPost(url, params, fileParams, DEFAULT_CHARSET, connectTimeout, readTimeout,head);
		}
	}
	 ...
	 */
	public static String doPost(String url, Map<String, String> params,
			Map<String, FileItem> fileParams, String charset,int connectTimeout,int readTimeout,Map<String,String> head) throws IOException {
		String boundary = System.currentTimeMillis() + ""; // 随机分隔线
		HttpURLConnection conn = null;
		OutputStream out = null;
		String rsp = null;		
