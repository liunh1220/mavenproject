...
public class RedisClientTemplate {
	...
	public List<Object> pipelined(ShardedJedisPipeline shardedJedisPipeline) {
		...
		ShardedJedisPipeline shardedJedisPipeline2 = new ShardedJedisPipeline();
		if (shardedJedis == null) {
			return result;
		}
		boolean broken = false;
		try {
			shardedJedisPipeline2 = shardedJedis.pipelined();
			result = shardedJedisPipeline2.getResults();
