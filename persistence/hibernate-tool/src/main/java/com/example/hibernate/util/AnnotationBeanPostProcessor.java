...
import com.example.hibernate.annotation.Property;
...
public class AnnotationBeanPostProcessor extends PropertyPlaceholderConfigurer
	...
	private Logger logger = LoggerFactory.getLogger(AnnotationBeanPostProcessor.class);
